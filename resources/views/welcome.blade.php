...
{{-- PORTADA ESTATICA
    <section class="bg-cover" style="background-image: url({{asset('img/home/pexels-sam-lion-6001670.jpg')}})">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-36">
            <div class="w-full md:w-3/4 lg:w-1/2">
                <h1 class="text-white font-bold text-4xl">Iniciamos las clases con ESAR VIRTUAL</h1>
    ...
    <section class="mt-24">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-8">
            ...
            {{-- <article>
                ...
                <header class="mt-2">
                    <h1 class="text-center text-xl text-gray-700">Inscríbete YA!</h1>
                </header>
                <p class="text-sm text-gray-500">
            ...
            <article>
                <figure>
                    <img class="rounded-xl h-36 w-full object-cover" src="{{asset('img/home/pexels-cottonbro-4713557.jpg')}}" alt="">
                </figure>
                <header class="mt-2">
                    <h1 class="text-center text-xl text-gray-700">Verifica tus accesos</h1>
                </header>
                <p class="text-sm text-gray-500">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum facilis veniam autem necessitatibus, dolores harum illum eaque? Velit officiis.
                </p>
            ...
            <article>
                <figure>
                    <img class="rounded-xl h-36 w-full object-cover" src="{{asset('img/home/pexels-giftpunditscom-1326946.jpg')}}" alt="">
                </figure>
                <header class="mt-2">
                    <h1 class="text-center text-xl text-gray-700">Aula Virtual</h1>
                </header>
                <p class="text-sm text-gray-500">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum facilis veniam autem necessitatibus, dolores harum illum eaque? Velit officiis.
                </p>
            ...
            <article>
                <figure>
                    <img class="rounded-xl h-36 w-full object-cover" src="{{asset('img/home/pexels-pixabay-207842.jpg')}}" alt="">
                </figure>
                <header class="mt-2">
