<x-app-layout>
    ...
    <section class="py-4 degrade">
        <small class="m-4 text-sm text-white font-bold">Inicio / Nosotros</small>
    </section>
    <section class="pb-24">
    <h1 class="m-4 text-4xl text-center text-green-500">Nosotros</h1>
        ...
        <div class="container pt-20">
            ...
            <div class="grid grid-cols-3 gap-x-6">
                ...
                <article class="card">
                    <img class=" h-80 w-100 object-cover" src="{{Storage::url($nosotro->image->url)}}" alt="">
                    <div class="card-body">
    ...
    {{-- <section class="bg-white">
        <div class="container rounded-xl my-4 py-4 text-justify">
            ...
            <div class="col-span-5 px-4 md:pl-2 lg:pl-24 lg:col-span-4">
                <h1 class="m-4 text-4xl text-center text-green-500">Reseña Histórica</h1>
                <hr><br>
